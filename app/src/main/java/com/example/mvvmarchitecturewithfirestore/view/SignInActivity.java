...
public class SignInActivity extends AppCompatActivity {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                if (account != null) {
                    ...
                    getGoogleAuthCreadential(account);
                }
    ...
    private void getGoogleAuthCreadential(GoogleSignInAccount account) {
        ...
        signInViewModel.auticationLiveData.observe(this, new Observer<String>() {
            @Override
